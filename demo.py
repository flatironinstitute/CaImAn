...
Yr,sn,g=cse.preprocess_data(Yr)
...
t1 = time()
Ain, Cin, b_in, f_in, center=cse.initialize_components(Y, K=nr, gSig=gSig, gSiz=gSiz, ssub=ssub, tsub=tsub, nIter = 5, use_median = False, kernel = None)                                                    
print time() - t1 # 
#%%
