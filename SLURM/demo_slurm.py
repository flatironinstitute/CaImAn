...
#############
# FIXME This demo is ancient and uses APIs that predate the modern codebase; it will not work

slurm_script = 'slurmStart.sh' # Replace this with a full path to your slurmStart script
