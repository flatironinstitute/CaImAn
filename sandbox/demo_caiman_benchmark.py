...
#%%
t_mmap_online = time()
fname = save_tif_to_mmap_online('k31_20160104_MMA_150um_65mW_zoom2p2_00001_00001.tif',
                                border_to_0=border_to_0, add_to_movie=add_to_movie)
...
images = tifffile.TiffFile(
    'k31_20160104_MMA_150um_65mW_zoom2p2_00001_00001.tif')
t_mc_online = time()
shifts, xcorrs, template = motion_correct_online(
    images, save_base_name=None, border_to_0=border_to_0, add_to_movie=add_to_movie)
t_mc_online_1 = time()
...
all_names, all_shifts, all_xcorrs, all_templates = motion_correct_online_multifile(
    fls, add_to_movie)
