...
srun bash -c 'KERAS_BACKEND=tensorflow CUDA_VISIBLE_DEVICES=-1 MKL_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 /mnt/home/agiovann/anaconda3/envs/caiman3/bin/python /mnt/home/agiovann//SOFTWARE/CaImAn/use_cases/CaImAnpaper/scripts_paper/batch_evaluate_timing.py $SLURM_PROCID'
