...
srun bash -c 'KERAS_BACKEND=tensorflow CUDA_VISIBLE_DEVICES=-1 MKL_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 /mnt/home/agiovann/anaconda3/envs/caiman_dev/bin/python /mnt/home/agiovann/SOFTWARE/CaImAn/use_cases/CaImAnpaper/scripts_paper/preprocess_neurofinder.py $SLURM_PROCID'
