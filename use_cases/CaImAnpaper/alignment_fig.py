...
files = glob(
    '/Users/epnevmatikakis/Documents/Ca_datasets/Taxidis/MultiDay/ROI*.mat')
...
[plt.contour(norm_nrg(mm), levels=[level], colors='b', linewidths=2)
 for mm in masks_1[ind_1]]
[plt.contour(norm_nrg(mm), levels=[level], colors='r', linewidths=2)
 for mm in masks_2[ind_2]]
[plt.contour(norm_nrg(mm), levels=[level], colors='y', linewidths=2)
