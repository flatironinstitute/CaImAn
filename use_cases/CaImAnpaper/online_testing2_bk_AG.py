...
if ploton:
    ...
    min_SNR = 2.5
    N_samples = np.ceil(params_movie[ind_dataset]['fr']*params_movie[ind_dataset]['decay_time']).astype(int)   # number of timesteps to consider when testing new neuron candidates
