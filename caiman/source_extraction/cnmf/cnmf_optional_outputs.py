...
class CNMF(object):
    ...
    def fit(self, images):
        ...
        options = CNMFParams(dims, T, self.n_processes, p=self.p, gSig=self.gSig, K=self.k, ssub=self.ssub, tsub=self.tsub,
        ...
        if self.rf is None:
            ...
            options = CNMFParams(dims, T, self.n_processes, p=self.p,
