...
class NeuronsDataset(utils.Dataset):
    ...
    def load_neurons(self, dataset_dir, subset):
        ...
        """
        group = [i for i in sorted(os.listdir(dataset_dir)) if i[-4:]=='.npz']
        ...
        for a in group:
            ...
            with zipfile.ZipFile(fname[:-4]+'.zip') as zf:
                names = zf.namelist()
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a neuron dataset image, delegate to parent class.
...
def train(model):
    ...
    augmentation = iaa.Sequential([iaa.Fliplr(0.5),
                                  ...
                                  sometimes(iaa.AdditiveGaussianNoise(loc=0, scale=(0.0, 0.05))),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/neuron/dataset/",
